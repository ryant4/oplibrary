...
function grabValues() {
    ...
    const newBook = new Book(formValues[0].value, formValues[1].value, formValues[2].value, formValues[3].value)
...
const toKillAMockingbird = new Book("To Kill a Mockingbird", "Harper Lee", "184", "on");
